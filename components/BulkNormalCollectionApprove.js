...
const BulkNormalCollectionApprove = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(DrawerContent, { "data-css": contentTag },
            ...
            React.createElement(MessageBox, { mb: "xxl", variant: "danger", message: translateMessage(records.length > 1
                    ? "theseRecordsWillBeApproved_plural"
                    : "theseRecordsWillBeApproved", resource.id, { count: records.length }) }),
        ...
        React.createElement(DrawerFooter, { "data-css": footerTag },
            React.createElement(Button, { variant: "contained", size: "lg", onClick: handleClick, disabled: loading },
                ...
                translateButton(records.length > 1
                    ? "confirmBulkNormalCollectionApprove_plural"
                    : "confirmNormalBulkCollectionApprove", resource.id, { count: records.length })))));
};
export default withNotice(BulkNormalCollectionApprove);
//# sourceMappingURL=BulkNormalCollectionApprove.js.map