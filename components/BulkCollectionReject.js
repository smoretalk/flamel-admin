...
const BulkCollectionReject = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(DrawerContent, { "data-css": contentTag },
            ...
            React.createElement(MessageBox, { mb: "xxl", variant: "danger", message: translateMessage(records.length > 1 ? 'theseRecordsWillBeRejected_plural' : 'theseRecordsWillBeRejected', resource.id, { count: records.length }) }),
...
export default withNotice(BulkCollectionReject);
//# sourceMappingURL=BulkCollectionReject.js.map