import { Box, Button, DatePicker, H5, Icon, Input, Label, Select, Text } from "@adminjs/design-system";
        ...
        React.createElement(Card, { as: "form", onSubmit: onSubmit },
            React.createElement(Text, { textAlign: "center" },
                ...
                React.createElement(Box, null,
                    ...
                    React.createElement(DatePicker, { onChange: onChangeDate, propertyType: "date" })),
                React.createElement(Box, null,
