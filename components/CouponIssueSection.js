...
export default function CouponIssueSection({}) {
    ...
    return (React.createElement(Box, { width: [1, 1, 1 / 2], p: "lg" },
        React.createElement(Card, { as: "form", onSubmit: onSubmit },
            ...
            React.createElement(Box, null,
                React.createElement(Label, null, "\uD06C\uB808\uB527or\uAE30\uAC04"),
                React.createElement(Input, { onChange: onChangeCredit, type: "number", placeholder: "\uD06C\uB808\uB527 \uC218 or \uAE30\uAC04(basic)", value: credit, style: { width: '100%' } })),
            React.createElement(Box, null,
