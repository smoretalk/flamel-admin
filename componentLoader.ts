...
componentLoader.override(
  "FilterDrawer",
  path.resolve(__dirname, "components", "FilterDrawer")
);
componentLoader.override(
...
export const Components = {
  ...
  BulkNormalCollectionApprove: componentLoader.add(
    "BulkNormalCollectionApprove",
    path.resolve(__dirname, "components", "BulkNormalCollectionApprove")
  ),
  ...
  IdQuerySaver: componentLoader.add(
    "IdQuerySaver",
    path.resolve(__dirname, "components", "IdQuerySaver")
  ),
  ExportCsv: componentLoader.add(
    "ExportCsv",
    path.resolve(__dirname, "components", "ExportCsv")
  ),
  ...
  M2MFilter: componentLoader.add(
    "M2MFilter",
    path.resolve(__dirname, "components", "M2MFilter")
  ),
  JsonDiff: componentLoader.add(
    "JsonDiff",
    path.resolve(__dirname, "components", "JsonDiff")
  ),
  ImageList: componentLoader.add(
    "ImageList",
    path.resolve(__dirname, "components", "List")
  ),
  PreserveQueryList: componentLoader.add(
    "PreserveQueryList",
    path.resolve(__dirname, "components", "PreserveQueryList")
  ),
  EditJSONB: componentLoader.add(
    "EditJSONB",
    path.resolve(__dirname, "components", "EditJSONB")
  ),
  ShowJSONB: componentLoader.add(
    "ShowJSONB",
    path.resolve(__dirname, "components", "ShowJSONB")
  ),
  ImageIdLink: componentLoader.add(
    "ImageIdLink",
    path.resolve(__dirname, "components", "ImageIdLink")
  ),
  LLMPromptIdLink: componentLoader.add(
    "LLMPromptIdLink",
    path.resolve(__dirname, "components", "LLMPromptIdLink")
  ),
  LimitTextLength: componentLoader.add(
    "LimitTextLength",
    path.resolve(__dirname, "components", "LimitTextLength")
  ),
  ImageEmbed: componentLoader.add(
    "ImageEmbed",
    path.resolve(__dirname, "components", "ImageEmbed")
  ),
  PlanAndModel: componentLoader.add(
    "PlanAndModel",
    path.resolve(__dirname, "components", "PlanAndModel")
  ),
  CopyAndAssign: componentLoader.add(
    "CopyAndAssign",
    path.resolve(__dirname, "components", "CopyAndAssign")
  ),
  AddEditedImage: componentLoader.add(
    "AddEditedImage",
    path.resolve(__dirname, "components", "AddEditedImage")
  ),
  ReferenceEditWithFilter: componentLoader.add(
    "ReferenceEditWithFilter",
    path.resolve(__dirname, "components", "ReferenceEditWithFilter")
  ),
};
